<?php
 ...
 /* $Id: imdb_person.class.php 517 2012-09-18 22:47:12Z izzy $ */
  ...
  * @version $Revision: 517 $ $Date: 2012-09-19 00:47:12 +0200 (Mi, 19. Sep 2012) $
  */
 ...
 #-----------------------------------------------------------[ Constructor ]---
  ...
  function __construct($id) {
    ...
    $this->revision = preg_replace('|^.*?(\d+).*$|','$1','$Revision: 517 $');
    $this->setid($id);
  }
