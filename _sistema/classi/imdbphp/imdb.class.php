<?php
 ...
 /* $Id: imdb.class.php 520 2012-09-20 19:01:50Z izzy $ */
  ...
  * @version $Revision: 520 $ $Date: 2012-09-20 21:01:50 +0200 (Do, 20. Sep 2012) $
  */
 ...
 #-----------------------------------------------------------[ Constructor ]---
  ...
  function __construct($id) {
    ...
    $this->revision = preg_replace('|^.*?(\d+).*$|','$1','$Revision: 520 $');
    $this->setid($id);
  }
